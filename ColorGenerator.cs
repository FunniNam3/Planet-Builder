...
public class ColorGenerator
{
    ...
    Texture2D texture;
    const int textureResoultion = 50;
    ...
    public void UpdateSettings(ColourSettings settings)
    {
        ...
        {
            texture = new Texture2D(textureResoultion * 2, settings.biomeColorSettings.biomes.Length, TextureFormat.RGBA32, false);
        }
    ...
    public void UpdateColors()
    {
        ...
        foreach (var biome in settings.biomeColorSettings.biomes)
        {
            ...
            for (int i = 0; i < textureResoultion * 2; i++)
            {
                Color gradientCol;
                if (i < textureResoultion)
                {
                    gradientCol = settings.oceanColor.Evaluate(i / (textureResoultion - 1f));
                }
                else
                {
                    gradientCol = biome.gradient.Evaluate((i - textureResoultion) / (textureResoultion - 1f));
                }
